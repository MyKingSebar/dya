...
//
//public class DossierHeartRateAutoActivity2 extends BaseActivity {
//
//
//
...
//    @BindView(R.id.radio_hand)
//    public RadioButton radioHand;
//    @BindView(R.id.radiogroup_dossier_heart_rate)
...
//                            dossierHeartrateAutoPreviewFragment.tvBluetoothState.setText("蓝牙状态:关闭");
//                        }
//                        deviceName = "";
...
//                        //showToast("蓝牙打开");
//                        if (null != dossierHeartrateAutoPreviewFragment) {
//                            dossierHeartrateAutoPreviewFragment.tvBluetoothState.setText("蓝牙状态:打开");
//                        }
...
//        super.onResume();
//        if (radioHand.isChecked()) {
//            if (isRadioBtnReset) {
//                resumeViewSet();
//                isRadioBtnReset = false;
//            }
//        }
...
//        radiogroupDossierHeartRate.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
//            @Override
